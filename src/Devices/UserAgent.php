...
class UserAgent
{
     ...
     * @return string
     */
    public static function buildUserAgent(DeviceInterface $device)
    {
        ...
        return sprintf(
            ...
            $device->getAppVersion(), // App version ("27.0.0.7.97").
        ...
        DeviceInterface $device)
    {
        ...
        $result = [
            'FBAN' => $appName,
            'FBAV' => $device->getAppVersion(),
            'FBBV' => $device->getVersionCode(),
            'FBDM' => sprintf('{density=%.1f,width=%d,height=%d}', $density, $width, $height),
            'FBLC' => $device->getLocale(),
