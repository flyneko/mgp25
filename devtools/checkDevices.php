...
foreach ($testDevices as $key => $deviceString) {
    ...
    $testDevices[$key] = new Device(Constants::IG_VERSION, Constants::VERSION_CODE, Constants::LOCALE, $deviceString, false);
}
...
{
    // Create the new Device object, without automatic fallbacks.
    $device = ($value instanceof DeviceInterface ? $value : new Device(Constants::IG_VERSION, Constants::VERSION_CODE, Constants::LOCALE, $value, false));
